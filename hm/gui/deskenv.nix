...
let
  noc-msg = act: "spawn:noctalia msg " + act;
in
{
  imports = [
  ...
  programs.umbriel = {
    enable = true;
    settings = {
      includes.optional.files = [ "~/.config/umbriel/noctalia.toml" ];
      general.show_cheatsheet = false;
      layout.gap = 2;
      input.keyboard.layout = "altgr-intl";
      keybinds = {
        "Mod+Escape" = "spawn:loginctl lock-session";
        "Mod+Return" = "spawn:kitty -1";
        "Mod+P" = {
          action = "spawn:${lib.getExe pkgs.wl-mirror} $(niri msg --json focused-output | jq -r .name)";
          repeat = false;
        };
        "Mod" = {
        ...
        # Noctalia
        "Mod+D" = noc-msg "panel-toggle launcher";
        "Mod+X" = noc-msg "panel-toggle session";
        "Mod+V" = noc-msg "panel-toggle clipboard";
        "Mod+Shift+S" = noc-msg "screenshot-region";
        "Print" = noc-msg "screenshot-region";
        "Alt+Print" = noc-msg "screenshot-annotate";

        # XF86
        "XF86AudioRaiseVolume" = noc-msg "volume-up";
        "XF86AudioLowerVolume" = noc-msg "volume-down";
        "XF86AudioMute" = noc-msg "volume-mute";
        "XF86AudioMicMute" = noc-msg "mic-mute";
        "XF86MonBrightnessUp" = noc-msg "brightness-up";
        "XF86MonBrightnessDown" = noc-msg "brightness-down";
        "XF86AudioPlay" = noc-msg "media toggle";
        "XF86AudioNext" = noc-msg "media next";
        "XF86AudioPrev" = noc-msg "media previous";
        "XF86KbdBrightnessUp" = noc-msg "keyboard-backlight-up";
        "XF86KbdBrightnessDown" = noc-msg "keyboard-backlight-down";
      };
    };
  };
